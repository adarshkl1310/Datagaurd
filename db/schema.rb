...
ActiveRecord::Schema[7.0].define(version: 2022_07_09_193513) do
  create_table "adarsh_rakeshes", force: :cascade do |t|
  ...
  create_table "team_employees", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["employee_id"], name: "index_team_employees_on_employee_id"
  ...
  add_foreign_key "team_employees", "employees"
